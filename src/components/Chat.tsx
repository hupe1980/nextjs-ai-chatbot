    ...
    <div className="flex flex-col h-full w-full overflow-y-auto justify-center items-left">
      {(messages.length > 0) ? (
        ...
        <div className="mb-24 md:mb-0 text-center max-w-sm ml-auto mr-auto p-6 bg-white">
          <h5 className="mb-2 text-2xl font-semibold tracking-tight text-chatbot">Enter a message to learn more about <span>{websiteBase}</span>.</h5>
      ...
      <div className="flex flex-row justify-center w-full">
        <form className="flex fixed bottom-20 md:bottom-14 w-full px-6 md:px-44 lg:px-56 flex-row justify-center space-x-2" onSubmit={e => {
          ...
          <input className="resize-y bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-chatbot focus:border-chatbot block w-full p-2.5" placeholder="Say something..."
            value={input}
      ...
      <div className="flex flex-row justify-center w-full px-6">
        <div className="flex bg-white py-2 fixed bottom-3 w-full flex-col md:flex-row justify-center items-center mx-6 md:space-x-1">
          <p className="text-gray-500 text-sm text-center">
            Built with
            <a href="https://js.langchain.com" target="_blank" className="ml-1 mr-1 inline-flex items-center font-medium text-chatbot hover:underline">LangChain</a>
            |
            <a href="https://nextjs.org" target="_blank" className="ml-1 mr-1 inline-flex items-center font-medium text-chatbot hover:underline">Next.js</a>
            |
            <a href="https://vercel.com/blog/introducing-the-vercel-ai-sdk" target="_blank" className="ml-1 mr-1 inline-flex items-center font-medium text-chatbot hover:underline">Vercel AI SDK</a>
            |
            <a href="https://lancedb.com" target="_blank" className="ml-1 mr-1 inline-flex items-center font-medium text-chatbot hover:underline">LanceDB</a>
            |
          </p>
          <a href="https://github.com/hupe1980/nextjs-ai-chatbot" target="_blank" className="ml-1 text-sm inline-flex items-center font-medium text-chatbot hover:underline">
            Visit chatbot repo
